...
namespace AASUnityEditor.XCodeEditor 
{
	public class XCPlist
	{
        ...
        public void Process(Hashtable plist)
        {
			...
			Dictionary<string, object> dict = (Dictionary<string, object>)AASPlistCS.Plist.readPlist(plistPath);
			...
			AASPlistCS.Plist.writeXml(dict, plistPath);
        }

...
// System.IO.Path.Combine(System.IO.Path.Combine(Application.dataPath, "PSSDK"), "Plugins"), "SDK.projmods", System.IO.SearchOption.AllDirectories);
			string[] projmods = System.IO.Directory.GetFiles(System.IO.Path.Combine(System.IO.Path.Combine(System.IO.Path.Combine(System.IO.Path.Combine(Application.dataPath, "PSSDK"), "Plugins"), "IOS"), "Mods"), "SDK.projmods",System.IO.SearchOption.AllDirectories);
